...
// with an admin-plane service token as a bearer — see ProvisionNamespaceConfig
// for why it still hand-rolls those two requests instead of using sdk/go/admin.
...
//
// Two scoring semantics matter to callers, both introduced in v0.8.0. Rankings now carry a per-item
