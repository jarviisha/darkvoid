    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ListBotsResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateBotRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Username already taken by another persona",
                        "schema": {
                            "$ref": "#/definitions/errors.ErrorResponse"
                        }
                    }
        ...
        "/admin/bots/config": {
            ...
            "put": {
                ...
                "operationId": "adminUpdateBotConfig",
                "parameters": [
                    {
        ...
        "/admin/bots/runs": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Limit to one persona (omit for all)",
                        "name": "bot_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ListRunsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/admin/bots/topics": {
            "get": {
                ...
                "operationId": "adminListBotTopics",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ListTopicsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "operationId": "adminCreateBotTopic",
                "parameters": [
                    {
                        "description": "Topic",
                        "name": "body",
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Topic already in the pool",
                        "schema": {
                            "$ref": "#/definitions/errors.ErrorResponse"
                        }
                    }
        ...
        "/admin/bots/topics/{id}": {
            "delete": {
                ...
                "operationId": "adminDeleteBotTopic",
                "parameters": [
                    {
                        "type": "string",
            ...
            "patch": {
                ...
                "operationId": "adminSetBotTopicEnabled",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Topic UUID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SetTopicEnabledRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateBotRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/bots/{id}/run-now": {
            "post": {
                ...
                "operationId": "adminRequestBotRun",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Persona UUID",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReportRunRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.LinkIdentityRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.BotResponse": {
            ...
            "properties": {
                ...
                "last_error_at": {
                    "type": "string",
                    "example": "2026-07-27T09:14:00Z"
                },
                "last_success_at": {
                    "type": "string",
                    "example": "2026-07-27T10:28:00Z"
                },
                "run_requested_at": {
                    "type": "string",
                ...
                "style": {
                    "type": "string",
                    "example": "giọng trẻ trung, hài hước"
                },
                "successes_last_24h": {
                    "type": "integer",
                    "example": 41
        ...
        "dto.CreateBotRequest": {
            ...
            "properties": {
                ...
                "style": {
                    "type": "string",
                    "example": "giọng trẻ trung, hài hước, hay dùng emoji"
                },
                "username": {
                    "type": "string",
                    "example": "bot_sky"
        ...
        "dto.CreateTopicRequest": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "một món ăn đường phố Việt Nam đáng nhớ"
                }
            }
        },
        ...
        "dto.PlanBot": {
            ...
            "properties": {
                ...
                "run_requested": {
                    "description": "RunRequested asks for an immediate post, out of band from the interval.",
                    "type": "boolean",
                    "example": false
                },
                "style": {
        ...
        "dto.PlanResponse": {
            ...
            "properties": {
                ...
                "paused": {
                    "description": "Paused tells the bot to keep polling but publish nothing.",
                    "type": "boolean",
                    "example": false
                },
                "post_interval_seconds": {
        ...
        "dto.RunResponse": {
            ...
            "properties": {
                ...
                "post_preview": {
                    "type": "string",
                    "example": "Sáng nay cà phê ở góc phố quen…"
                },
                "status": {
                    "type": "string",
                    "example": "success"
        ...
        "dto.TopicResponse": {
            ...
            "properties": {
                "content": {
                    "type": "string",
                    "example": "quán cà phê mới phát hiện ở góc phố quen"
                },
                "created_at": {
                    "type": "string",
                    "example": "2026-07-27T08:00:00Z"
        ...
        "dto.UpdateBotRequest": {
            ...
            "properties": {
                ...
                "style": {
                    "type": "string",
                    "example": "giọng trầm lắng, tản văn"
                }
            }
        },
